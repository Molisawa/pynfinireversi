...
class Screen(ScreenMediatorInterface):
    ...
    '''
    def __init__(self, board:Board, frame_count: int, menu_options: Menu, screen_flag: bool, slider: screen_specs.Slider, selected_piece: Piece) -> None:
        '''
    ...
    def __initalize_components(self)->None:
        ...
        import main_screen, game_screen, load_screen, editor_screen
